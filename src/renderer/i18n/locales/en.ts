export const en = {
  ...
  diff: {
    ...
    phase: {
      ...
      comparing: 'Comparing {{done}}/{{total}} shared table(s)...',
      comparingPending: 'Comparing {{done}}/{{total}} shared table(s)... Pending: {{pending}}',
      doneNoShared: 'Only source-only/target-only tables were found. Results are ready.',
      done: 'Compared {{done}}/{{total}} shared table(s).',
    ...
    result: {
      ...
      sharedTables: '{{count}} shared tables',
